...
public class LPDOreBlock extends LpdsLargeModModElements.ModElement {
	@ObjectHolder("lpds_large_mod:lpd_ore")
	public static final Block block = null;
	public LPDOreBlock(LpdsLargeModModElements instance) {
		super(instance, 1);
	}
