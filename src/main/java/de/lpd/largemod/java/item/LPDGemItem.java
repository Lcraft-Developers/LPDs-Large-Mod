...
public class LPDGemItem extends LpdsLargeModModElements.ModElement {
	@ObjectHolder("lpds_large_mod:lpd_gem")
	public static final Item block = null;
	public LPDGemItem(LpdsLargeModModElements instance) {
		super(instance, 4);
	}
